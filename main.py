...
data = pd.read_csv('C:\\Users\\User\\OneDrive\\Documents\\Desktop\\Machine Learning\\train.csv')
...
bg_image = Image.open(os.path.join(os.path.dirname(__file__), "C:\\Users\\User\\Downloads\\background.jpeg"))
